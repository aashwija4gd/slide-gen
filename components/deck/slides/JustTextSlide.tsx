import type { JustTextSlide } from '@/types/slides'

export default function JustTextSlide({ slide }: { slide: JustTextSlide }) {
  return (
    <div className="grid grid-cols-3 flex-1 overflow-hidden" style={{ backgroundColor: 'var(--color-bg-surface)' }}>
      ...
      <div className="col-span-1" style={{ backgroundColor: 'var(--color-bg-surface)' }} />
    </div>
  )
}
